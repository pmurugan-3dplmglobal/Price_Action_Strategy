...
for p in [_SCRIPT_DIR, _COMMON_DIR]:
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(paths.log_file("token_generation.log"), mode="w", encoding="utf-8"),
...
def main():
    ...
    try:
        logging.info("Processing string parameters from redirection data...")
