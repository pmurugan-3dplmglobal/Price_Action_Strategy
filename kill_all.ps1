Write-Host "Killing Price Action Strategy processes..." -ForegroundColor Yellow
Write-Host ""
...
$targets = $procs | Where-Object {
    $_.CommandLine -match 'Price_Action_Strategy' -and (
        ...
        $_.CommandLine -match 'stock_reversal_scanner' -or
        ...
        $_.CommandLine -match 'app_Stock_Trade' -or
        $_.CommandLine -match 'app_Sock_Trade' -or
        $_.CommandLine -match 'run_export_scheduler_daemon' -or
        $_.CommandLine -match 'automated_strategy_exporter'
    )
}
